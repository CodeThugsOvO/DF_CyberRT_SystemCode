// Generated by gencpp from file dfcv_mining_msgs/CAN_TO_CTRL_HCU.msg
// DO NOT EDIT!


#ifndef DFCV_MINING_MSGS_MESSAGE_CAN_TO_CTRL_HCU_H
#define DFCV_MINING_MSGS_MESSAGE_CAN_TO_CTRL_HCU_H
...
struct CAN_TO_CTRL_HCU_
{
  typedef CAN_TO_CTRL_HCU_<ContainerAllocator> Type;
  ...
  CAN_TO_CTRL_HCU_(const ContainerAllocator& _alloc)
    : VehDa_prcActuTrq_mp(0)
    , VehDa_prcDrvrDmdTrq_mp(0)
    , VehDa_stSrcEngCtrl_mp(0)
    , VehDa_nEngSpd_mp(0.0)
  ...
  typedef boost::shared_ptr< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> const> ConstPtr;

}; // struct CAN_TO_CTRL_HCU_

typedef ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<std::allocator<void> > CAN_TO_CTRL_HCU;

typedef boost::shared_ptr< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU > CAN_TO_CTRL_HCUPtr;
typedef boost::shared_ptr< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU const> CAN_TO_CTRL_HCUConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator1> & lhs, const ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator2> & rhs)
{
  return lhs.VehDa_prcActuTrq_mp == rhs.VehDa_prcActuTrq_mp &&
    lhs.VehDa_prcDrvrDmdTrq_mp == rhs.VehDa_prcDrvrDmdTrq_mp &&
    lhs.VehDa_stSrcEngCtrl_mp == rhs.VehDa_stSrcEngCtrl_mp &&
    lhs.VehDa_nEngSpd_mp == rhs.VehDa_nEngSpd_mp &&
    lhs.VehDa_prcTrqEngNomFric_mp == rhs.VehDa_prcTrqEngNomFric_mp &&
    lhs.VehDa_prcTrqEstimdLoss_mp == rhs.VehDa_prcTrqEstimdLoss_mp &&
    lhs.VehDa_stCluSwt_mp == rhs.VehDa_stCluSwt_mp &&
    lhs.VehDa_trqEngRef_mp == rhs.VehDa_trqEngRef_mp &&
    lhs.VehDa_jEng_mp == rhs.VehDa_jEng_mp &&
    lhs.VehDa_rAccrPedl_mp == rhs.VehDa_rAccrPedl_mp;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x404e92e7756d49a8ULL;
  static const uint64_t static_value2 = 0xab62fd99fbd5cd35ULL;
};

template<class ContainerAllocator>
struct DataType< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dfcv_mining_msgs/CAN_TO_CTRL_HCU";
  }
...
template<class ContainerAllocator>
struct Definition< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dfcv_mining_msgs::CAN_TO_CTRL_HCU_<ContainerAllocator>& v)
  {
...
#endif // DFCV_MINING_MSGS_MESSAGE_CAN_TO_CTRL_HCU_H
